...
-- orders
--
INSERT INTO orders (id, placement_date, status_change_date, subtotal_price, total_price, days, discount_id, address,
                    latitude,
...
VALUES (NEXTVAL('seq_orders_id'), TO_TIMESTAMP('2022-11-16 07:50:10-02:00', 'YYYY-MM-DD HH24:MI:SSTZH:TZM'),
        TO_TIMESTAMP('2022-11-18 14:23:05-01:00', 'YYYY-MM-DD HH24:MI:SSTZH:TZM'), 645.69, 613.41, 1, 1,
